...
class SchemaDeleteDeviceApp(Schema):
    """Schema for DeleteDeviceApp API.
...
class DeleteDeviceApp(ConsoleAccessBaseClass):
    """This class implements DeleteDeviceApp API.
    ...
    def delete_device_app(self, app_name: str, version_number: str):
        ...
        try:
            ...
            # Validate schema
            _path_params = SchemaDeleteDeviceApp().load(_local_params)
            ...
            with aitrios_console_rest_client_sdk_primitive.ApiClient(
                ...
                try:
                    _return_delete_device_app = delete_device_app_api_instance.delete_device_app(
                        path_params=_path_params
                    )
                    return _return_delete_device_app.body

                except aitrios_console_rest_client_sdk_primitive.ApiKeyError as key_err:
                    _return_delete_device_app = self.on_key_error_response(__name__, key_err)

                except aitrios_console_rest_client_sdk_primitive.ApiTypeError as type_err:
                    _return_delete_device_app = self.on_type_error_response(__name__, type_err)

                except aitrios_console_rest_client_sdk_primitive.ApiValueError as val_err:
                    _return_delete_device_app = self.on_value_error_response(__name__, val_err)

                except aitrios_console_rest_client_sdk_primitive.ApiAttributeError as attr_err:
                    _return_delete_device_app = self.on_attribute_error_response(__name__, attr_err)

                except aitrios_console_rest_client_sdk_primitive.ApiException as exception:
                    _return_delete_device_app = self.on_http_error_response(__name__, exception)

                except Exception as exception:
                    _return_delete_device_app = self.on_generic_error_response(__name__, exception)

        except ValidationError as err:
            _return_delete_device_app = self.on_validation_error_response(__name__, err)

        return _return_delete_device_app
