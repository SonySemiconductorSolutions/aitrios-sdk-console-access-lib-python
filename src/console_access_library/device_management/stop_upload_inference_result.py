...
class SchemaStopUploadInferenceResult(Schema):
    """Schema for StopUploadInferenceResult API.
...
class StopUploadInferenceResult(ConsoleAccessBaseClass):
    """This class implements StopUploadInferenceResult API.
    ...
    def stop_upload_inference_result(self, device_id: str):
        ...
        Example:
            .. code-block:: python
                ...
                response = device_management_obj.stop_upload_inference_result(
                    device_id)
                pprint(response)
        """
        ...
        try:
            ...
            with aitrios_console_rest_client_sdk_primitive.ApiClient(
                ...
                try:
                    ...
                    _return_stop_upload_inference_result = self.on_http_error_response(
                        __name__, exception
                    )
