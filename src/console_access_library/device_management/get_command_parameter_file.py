...
class GetCommandParameterFile(ConsoleAccessBaseClass):
    ...
    def get_command_parameter_file(self):
        """Get command parameter file list.

        Returns:
            dict:
                - **Success Response** : Dictionary with below key and value pairs.

                    - ``parameter_list`` (object) : List of CommandParameters registered in Console
        ...
        Example:
            .. code-block:: python
                ...
                response = console_sdk_client_obj.device_management.get_command_parameter_file()
                pprint(response)
        """
