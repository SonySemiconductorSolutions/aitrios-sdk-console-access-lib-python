...
# settings to include source code link at each module description, also include the extensions, "sphinx.ext.autodoc", "sphinx.ext.viewcode",           "sphinx.ext.intersphinx", "sphinx.ext.autosummary", to make this work.
...
# shorten the module names only to current module and not include the parent class details, if given as false
