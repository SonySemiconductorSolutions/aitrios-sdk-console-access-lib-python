...
class ModelVersion(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["version_number", "iteration_id", "iteration_name", "accuracy", "model_performances", "latest_flg", "publish_latest_flg", "version_status", "org_file_name", "org_file_size", "publish_file_name", "publish_file_size", "model_file_size", "model_framework", "conv_id", "labels", "stage", "result", "kpi", ], str]):
