            ...
            class model(
                ...
                class MetaOapg:
                    ...
                    class properties:
                        ...
                        @staticmethod
                        def latest_version() -> typing.Type['ModelVersion']:
                            return ModelVersion
                        __annotations__ = {
                            "model_id": model_id,
                ...
                @typing.overload
                def __getitem__(self, name: typing_extensions.Literal["latest_version"]) -> 'ModelVersion': ...
                ...
                @typing.overload
                def get_item_oapg(self, name: typing_extensions.Literal["latest_version"]) -> typing.Union['ModelVersion', schemas.Unset]: ...
                ...
                def __new__(
                    ...
                    *_args: typing.Union[dict, frozendict.frozendict, ],
                    ...
                    latest_version: typing.Union['ModelVersion', schemas.Unset] = schemas.unset,
                    _configuration: typing.Optional[schemas.Configuration] = None,
                    **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
                ) -> 'model':
                    return super().__new__(
