...
class Devices(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["device_id", "place", "comment", "property", "device_type", "display_device_type", "ins_id", "ins_date", "upd_id", "upd_date", "connectionState", "lastActivityTime", "models", "configuration", "state", "device_groups", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["connectionState"]) -> typing.Union[MetaOapg.properties.connectionState, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["lastActivityTime"]) -> typing.Union[MetaOapg.properties.lastActivityTime, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["device_id", "place", "comment", "property", "device_type", "display_device_type", "ins_id", "ins_date", "upd_id", "upd_date", "connectionState", "lastActivityTime", "models", "configuration", "state", "device_groups", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        upd_id: typing.Union[MetaOapg.properties.upd_id, str, schemas.Unset] = schemas.unset,
        upd_date: typing.Union[MetaOapg.properties.upd_date, str, schemas.Unset] = schemas.unset,
        connectionState: typing.Union[MetaOapg.properties.connectionState, str, schemas.Unset] = schemas.unset,
        lastActivityTime: typing.Union[MetaOapg.properties.lastActivityTime, str, schemas.Unset] = schemas.unset,
