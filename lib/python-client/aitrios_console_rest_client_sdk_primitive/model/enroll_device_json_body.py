...
class EnrollDeviceJsonBody(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["device_name", "primary_certificate", "device_type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["device_name", "primary_certificate", "device_type", ], str]):
