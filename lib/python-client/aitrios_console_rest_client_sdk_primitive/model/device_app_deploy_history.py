...
class DeviceAppDeployHistory(
            ...
            class devices(
                ...
                class MetaOapg:
                    ...
                    class items(
                        ...
                        def __getitem__(self, name: typing.Union[typing_extensions.Literal["device_id", "status", "latest_deployment_flg", "ins_id", "ins_date", "upd_id", "upd_date", ], str]):
                        ...
                        def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["device_id", "status", "latest_deployment_flg", "ins_id", "ins_date", "upd_id", "upd_date", ], str]):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "total_status", "deploy_parameter", "devices", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "total_status", "deploy_parameter", "devices", ], str]):
        return super().get_item_oapg(name)
