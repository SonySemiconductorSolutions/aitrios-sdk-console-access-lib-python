...
# body param
SchemaForRequestBodyApplicationJson = DeployDeviceAppJsonBody


request_body_deploy_device_app_json_body = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _deploy_device_app_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_deploy_device_app_json_body.serialize(body, content_type)
...
class DeployDeviceApp(BaseApi):
    ...
    def deploy_device_app(
        ...
        return self._deploy_device_app_oapg(
            body=body,
