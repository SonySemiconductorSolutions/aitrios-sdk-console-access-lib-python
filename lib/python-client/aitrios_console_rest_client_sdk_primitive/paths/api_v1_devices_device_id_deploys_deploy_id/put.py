...
DeployIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'device_id': typing.Union[DeviceIdSchema, str, ],
        'deploy_id': typing.Union[DeployIdSchema, str, ],
    }
)
...
request_path_deploy_id = api_client.PathParameter(
    name="deploy_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=DeployIdSchema,
    required=True,
)
...
class BaseApi(api_client.Api):
    ...
    def _deploy_device_cancel_oapg(
        self: api_client.Api,
...
class DeployDeviceCancel(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def deploy_device_cancel(
        self: BaseApi,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        ...
        return self._deploy_device_cancel_oapg(
