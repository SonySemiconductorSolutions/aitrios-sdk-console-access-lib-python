...
# body param
SchemaForRequestBodyApplicationJson = ImportDeviceAppJsonBody


request_body_import_device_app_json_body = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _import_device_app_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_import_device_app_json_body.serialize(body, content_type)
...
class ImportDeviceApp(BaseApi):
    ...
    def import_device_app(
        ...
        return self._import_device_app_oapg(
            body=body,
