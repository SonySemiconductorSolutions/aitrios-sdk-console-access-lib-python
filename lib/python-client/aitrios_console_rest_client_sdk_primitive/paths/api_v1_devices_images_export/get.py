...
RedcowinraincipherSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'redcowinraincipher': typing.Union[RedcowinraincipherSchema, str, ],
    },
    total=False
)
...
request_query_redcowinraincipher = api_client.QueryParameter(
    name="redcowinraincipher",
    style=api_client.ParameterStyle.FORM,
    schema=RedcowinraincipherSchema,
    explode=True,
)
...
class BaseApi(api_client.Api):
    ...
    def _export_images_oapg(
        ...
        for parameter in (
            ...
            request_query_redcowinraincipher,
        ):
