...
# body param
SchemaForRequestBodyApplicationJson = ImportBaseModelJsonBody


request_body_import_base_model_json_body = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _import_base_model_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_import_base_model_json_body.serialize(body, content_type)
