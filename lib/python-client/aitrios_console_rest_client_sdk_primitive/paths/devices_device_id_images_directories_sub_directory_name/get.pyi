...
request_query_number_of_images = api_client.QueryParameter(
    name="number_of_images",
    style=api_client.ParameterStyle.FORM,
    schema=NumberOfImagesSchema,
    explode=True,
)
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'sub_directory_name': typing.Union[SubDirectoryNameSchema, str, ],
    }
)
...
request_path_sub_directory_name = api_client.PathParameter(
    name="sub_directory_name",
    style=api_client.ParameterStyle.SIMPLE,
    schema=SubDirectoryNameSchema,
    required=True,
)
