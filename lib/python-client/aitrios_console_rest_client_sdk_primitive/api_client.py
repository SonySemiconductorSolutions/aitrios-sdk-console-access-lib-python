...
from aitrios_console_rest_client_sdk_primitive import rest
from aitrios_console_rest_client_sdk_primitive.configuration import Configuration
from aitrios_console_rest_client_sdk_primitive.exceptions import ApiTypeError, ApiValueError
from aitrios_console_rest_client_sdk_primitive.schemas import (
    NoneClass,
    BoolClass,
    Schema,
    FileIO,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/1.2.0rc1/python'
