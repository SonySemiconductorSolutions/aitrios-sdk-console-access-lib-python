...
:sectnums:
:sectnumlevels: 1
:author: Copyright 2023, 2024 Sony Semiconductor Solutions Corporation
...
** get_images(device_id: str, sub_directory_name: str, number_of_images: int, skip: int, order_by: str, from_datetime: str, to_datetime: str)
...
** get_image_data(device_id: str, sub_directory_name: str, number_of_images: int, skip: int, order_by: str, from_datetime: str, to_datetime: str)
